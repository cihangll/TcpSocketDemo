namespace TcpServerAsyncUI
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.ConnectToServerEvent);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.SendAllEvent);
			// 
			// label1
			// 
			...
			// textMessage
			// 
			this.textMessage.Location = new System.Drawing.Point(448, 15);
			...
			this.button3.Click += new System.EventHandler(this.StopServerEvent);
			// 
			// textConsole
			// 
			this.textConsole.Location = new System.Drawing.Point(12, 61);
			this.textConsole.Multiline = true;
			this.textConsole.Name = "textConsole";
			this.textConsole.Size = new System.Drawing.Size(536, 347);
